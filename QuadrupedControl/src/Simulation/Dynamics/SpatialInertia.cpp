...
SpatialInertia::SpatialInertia(double mass, const MathTypes::Vec3& com, const MathTypes::Mat3& inertiaMatrix)
{
...
{
    this->inertia.noalias() += otherInertia;
}
